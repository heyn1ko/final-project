...
export default function Footer() {
  return (
    <footer className="font-display font-[300] p-2 mb-0 mt-44 pl-10 pr-10 outline-dotted flex flex-col md:flex-row justify-between items-center m-0">
      <div className="flex items-center space-x-4 space-y-1 md:order-1">
        <p>FOLLOW US ON</p>
      ...
      <div className="flex items-center space-x-4 space-y-1 md:order-2 mt-4 md:mt-0">
        <p>STAY UP TO DATE</p>
        <input
          type="text"
          placeholder="ENTER YOUR EMAIL"
          className="border border-gray-300 rounded-md w-60 md:w-auto px-2 py-1 mt-2 outline-dotted"
        />
