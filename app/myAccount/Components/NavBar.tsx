  ...
  return (
    <div className=" grid grid-cols-3 gap-x-1 pl-10 pr-10  pt-10 divide-y-6">
      <div>
        ...
        <Link
          href="/admin"
          className="text-blue-950 font-display font-[900] flex items-center gap-x-2 p-1 text-4xl tracking-wider	hover:text-[#0000EE]	"
        >
          ACCOUNT
        </Link>
        <hr className="w-48 h-2 my-10 pl-10 bg-gray-100 border-0 md:my-10 dark:bg-gray-700" />
      </div>
      <div className="absolute right-10	pb-10 font-display font-[500]  items-center gap-x-2 p-1 text-4xl gap-80 text-cyan-800	hover:text-[#0000EE]">
        {user ? (
          <form action={signOut}>
